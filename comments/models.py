...
class CommentReply(models.Model):
    ...
    author = models.ForeignKey(User, related_name='user_comment_replies', null=True, blank=True, on_delete=models.CASCADE)
    replay_user = models.ForeignKey(User, related_name='user_replied', null=True, blank=True, on_delete=models.CASCADE)
